...
BENCHMARK_SCHEMA = "openmind.maf_resident_pk_directory_benchmark.v1"
BENCHMARK_VERSION = "maf_resident_pk_directory_benchmark_v1"
...
RESULT = Path("experiments/model_fractal/benchmark_maf_resident_pk_directory_v1.json")
RUNTIME = Path("results/runtime/maf_resident_pk_directory_benchmark_v1")
...
def main():
    ...
    print("=" * 72)
    print(" OPENMIND / RESIDENT PK DIRECTORY BENCHMARK V1")
    print("=" * 72)
