...
CORRECTION_PROTOCOL = HERE / "MAF_QUERY_CAPSULE_ATTACH_DETACH_CLEANUP_VALIDATION_V1_1_CORRECTION_PROTOCOL.md"
RUNNER_SHA_AUTHORITY = HERE / "maf_query_capsule_attach_detach_cleanup_validation_v1_1.py.sha256"
SLOT_PATH = HERE / "maf_query_capsule_attach_detach_cleanup_validation_v1_1.slot"
PARTIAL_PATH = HERE / "maf_query_capsule_attach_detach_cleanup_validation_v1_1.json.partial"
RESULT_PATH = HERE / "maf_query_capsule_attach_detach_cleanup_validation_v1_1.json"
FAILED_V1_RUNNER_PATH = HERE / "maf_query_capsule_attach_detach_cleanup_validation_v1.py"
FAILED_V1_RUNNER_SHA_AUTHORITY = HERE / "maf_query_capsule_attach_detach_cleanup_validation_v1.py.sha256"
FAILED_V1_SLOT_PATH = HERE / "maf_query_capsule_attach_detach_cleanup_validation_v1.slot"
FAILED_V1_PARTIAL_PATH = HERE / "maf_query_capsule_attach_detach_cleanup_validation_v1.json.partial"
FAILED_V1_RESULT_PATH = HERE / "maf_query_capsule_attach_detach_cleanup_validation_v1.json"
...
CORRECTION_PROTOCOL_SHA256 = "27c820f292fae9bbbfe032d722da4d6ecadc237ca47b8119c82e93313a0d78af"
FAILED_V1_RUNNER_SHA256 = "b3a0812f5abe7549ce2282efce78b33628d7cbc42689ba236c43ec1b767d4638"
FAILED_V1_RUNNER_SHA_AUTHORITY_SHA256 = "7d1b08467817553d735106fd6d423f6e90057232aaf913d0ba9ba4c575778eaf"
FAILED_V1_SLOT_SHA256 = "17cc5ac3ecd2caf6822dd6fb36b8c0273dda5bbde6791b598a51b933bb079a33"
FAILED_V1_PARTIAL_SHA256 = "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"
...
RESULT_SCHEMA = "openmind.maf_query_capsule_attach_detach_cleanup_validation.v1_1"
...
def _prequal() -> dict[str, Any]:
    ...
    require(file_sha256(CORRECTION_PROTOCOL) == CORRECTION_PROTOCOL_SHA256, "V1.1 correction protocol SHA mismatch")
    require(file_sha256(FAILED_V1_RUNNER_PATH) == FAILED_V1_RUNNER_SHA256, "failed V1 runner SHA mismatch")
    require(file_sha256(FAILED_V1_RUNNER_SHA_AUTHORITY) == FAILED_V1_RUNNER_SHA_AUTHORITY_SHA256, "failed V1 runner SHA authority file mismatch")
    require(FAILED_V1_RUNNER_SHA_AUTHORITY.read_text(encoding="ascii") == FAILED_V1_RUNNER_SHA256 + "\n", "failed V1 runner SHA authority content mismatch")
    require(file_sha256(FAILED_V1_SLOT_PATH) == FAILED_V1_SLOT_SHA256, "failed V1 slot SHA mismatch")
    require(file_sha256(FAILED_V1_PARTIAL_PATH) == FAILED_V1_PARTIAL_SHA256, "failed V1 partial SHA mismatch")
    require(FAILED_V1_PARTIAL_PATH.stat().st_size == 0, "failed V1 partial must remain empty")
    require(not FAILED_V1_RESULT_PATH.exists(), "failed V1 result must remain absent")
    ...
    resident = _load_module("maf_resident_pk_directory_v1", RESIDENT_IMPL)
    existing_resident = sys.modules.get("maf_resident_pk_directory_v1")
    require(existing_resident is None or existing_resident is resident, "V1.1 canonical resident module identity conflict")
    sys.modules["maf_resident_pk_directory_v1"] = resident
    runtime = _load_module("openmind_q3_runtime", RUNTIME_IMPL)
    require(resident.ResidentPKEntry is runtime.ResidentPKEntry, "V1.1 resident/runtime ResidentPKEntry identity mismatch")
    ...
    return {
        ...
        "failed_v1_runner_sha256": FAILED_V1_RUNNER_SHA256,
        "failed_v1_runner_sha_authority_sha256": FAILED_V1_RUNNER_SHA_AUTHORITY_SHA256,
        "failed_v1_slot_sha256": FAILED_V1_SLOT_SHA256,
        "failed_v1_partial_sha256": FAILED_V1_PARTIAL_SHA256,
        "failed_v1_result_absent": not FAILED_V1_RESULT_PATH.exists(),
        "resident_runtime_entry_class_identity": resident.ResidentPKEntry is runtime.ResidentPKEntry,
        "q1": q1,
        "runtime": runtime,
        "resident": resident,
        "selector": selector,
...
def _build_result(preq: dict[str, Any], science: dict[str, Any]) -> tuple[dict[str, Any], bytes]:
    result = {
        ...
        "correction_provenance": {
            "correction_protocol_sha256": preq["correction_protocol_sha256"],
            "failed_v1_runner_sha256": preq["failed_v1_runner_sha256"],
            "failed_v1_runner_sha_authority_sha256": preq["failed_v1_runner_sha_authority_sha256"],
            "failed_v1_slot_sha256": preq["failed_v1_slot_sha256"],
            "failed_v1_partial_sha256": preq["failed_v1_partial_sha256"],
            "failed_v1_result_absent": preq["failed_v1_result_absent"],
            "resident_runtime_entry_class_identity": preq["resident_runtime_entry_class_identity"],
        },
        "fixture_authority_sha256": FIXTURE_AUTHORITY_SHA256,
        "active_record_sha256": ACTIVE_RECORD_SHA256,
        "model_pk": MODEL_PK,
...
def main() -> int:
    ...
    print(
        "usage: maf_query_capsule_attach_detach_cleanup_validation_v1_1.py "
