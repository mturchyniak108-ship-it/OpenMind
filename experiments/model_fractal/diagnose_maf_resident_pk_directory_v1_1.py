...
SCHEMA = "openmind.maf_resident_pk_directory_diagnostics.v1_1"
VERSION = "maf_resident_pk_directory_diagnostics_v1_1"
...
RESULT = Path("experiments/model_fractal/maf_resident_pk_directory_diagnostics_v1_1.json")
RUNTIME = Path("results/runtime/maf_resident_pk_directory_diagnostics_v1_1")
...
def main():
    ...
    print("=" * 72)
    print(" OPENMIND / RESIDENT PK DIRECTORY DIAGNOSTICS V1.1")
    print("=" * 72)
