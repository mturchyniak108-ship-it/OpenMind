...
RUNNER_PATH=Path("experiments/model_fractal/maf_phase_6e_d_class_a_positive_model_load_validation_v2.py")

RESULT_PATH=Path("experiments/model_fractal/maf_phase_6e_d_class_a_positive_model_load_validation_v2.json")
...
SCHEMA="openmind.maf_phase_6e_d_class_a_positive_model_load_validation.v2"
...
def runner_commit_checkpoint():
    ...
    sentinel=(
        ...
        /(
            "phase_6e_d_class_a_positive_model_load_v2_"
            +runner_sha
            +".spent"
        )
    )
