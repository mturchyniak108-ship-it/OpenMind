#!/usr/bin/env python3
"""Exact-once Phase 6C MAF Object Runtime and Residency V1.2 validation."""
...
SCHEMA = "openmind.maf_object_runtime_residency_validation.v1.2"
...
def main() -> int:
    if RESULT_PATH.exists():
        raise ValidationHarnessError(
            "validation result already exists; V1.2 rerun forbidden"
        )
    ...
    print(
        "OPENMIND / MAF OBJECT RUNTIME RESIDENCY VALIDATION V1.2"
    )
    print(
        "validation_valid:",
