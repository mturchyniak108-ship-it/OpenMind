#!/usr/bin/env python3
"""MAF Segment Reader Benchmark V1.2 exact-once runner.

Implements the frozen V1.2 corrective preregistration; measurement policy remains inherited from frozen V1.1. The frozen V1 benchmark module is
...
SCHEMA = "openmind.maf_segment_reader_benchmark.v1_2"

PROTOCOL = Path("experiments/model_fractal/MAF_SEGMENT_READER_BENCHMARK_V1_2_PROTOCOL.md")
...
V1_1_PROTOCOL = Path("experiments/model_fractal/MAF_SEGMENT_READER_BENCHMARK_V1_1_PROTOCOL.md")
V1_1_RUNNER = Path("experiments/model_fractal/benchmark_maf_segment_reader_v1_1.py")
V1_1_RESULT = Path("experiments/model_fractal/maf_segment_reader_benchmark_v1_1.json")
RESULT = Path("experiments/model_fractal/maf_segment_reader_benchmark_v1_2.json")
...
EXPECTED = {
    "protocol": "c49c75fee93b28805f03280a775f703c2395826124c43993f97ff3358367c5db",
    "v1_1_protocol": "8a6af3a65c78c0ed9f47244ebd40613c5e84f13fc2e4e2d1543089e5481e3770",
    "v1_1_runner": "d1e17670aad32dbb57deb29e588aad656735ff60582202f4436b5db2b89bda69",
    "v1_1_result": "a4f31246e5412110487abac7b0304c16fd9528b48b22e882be6c6c5b48feb2e3",
...
def verify_frozen_identities() -> dict[str, Any]:
    bound = {
        "protocol": PROTOCOL,
        "v1_1_protocol": V1_1_PROTOCOL,
        "v1_1_runner": V1_1_RUNNER,
        "v1_1_result": V1_1_RESULT,
        "v1_core": V1_CORE,
...
def run_v1_2_benchmark(v1: Any, thermal: Any, identity_evidence: dict[str, Any]):
...
def main() -> None:
    ...
    try:
        result = run_v1_2_benchmark(v1, thermal, identity_evidence)
    except BaseException as exc:
