...
RUNNER_COMMIT_SUBJECT="research: freeze Phase 6E-D Class-A positive model-load validation V4 runner"

RUNNER_PATH=Path("experiments/model_fractal/maf_phase_6e_d_class_a_positive_model_load_validation_v4.py")

RESULT_PATH=Path("experiments/model_fractal/maf_phase_6e_d_class_a_positive_model_load_validation_v4.json")
...
SCHEMA="openmind.maf_phase_6e_d_class_a_positive_model_load_validation.v4"
...
def runner_commit_checkpoint():
    ...
    sentinel=(
        ...
        /(
            "phase_6e_d_class_a_positive_model_load_v4_"
            +runner_sha
            +".spent"
        )
    )
