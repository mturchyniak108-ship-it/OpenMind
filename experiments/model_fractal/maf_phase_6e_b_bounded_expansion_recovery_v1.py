...
PREREG_PATH = EXPERIMENT_DIR / "MAF_PHASE_6E_B_BOUNDED_EXPANSION_RECOVERY_PREREGISTRATION_V1.md"
PREREG_SHA256 = "85b44a1e78193f020c54b12f9b0698b8c20cc3a69365647b9520132d4b01dacd"

RUNNER_CONTRACT_PATH = EXPERIMENT_DIR / "MAF_PHASE_6E_B_BOUNDED_EXPANSION_RECOVERY_RUNNER_IMPLEMENTATION_CONTRACT_V1.md"
RUNNER_CONTRACT_SHA256 = "747261cce78f770401155e4823bc3558bc6e41770f107d35a965e014e5cc6fb5"
...
OUTPUT_PATH = EXPERIMENT_DIR / "maf_phase_6e_b_bounded_expansion_recovery_v1.json"
...
TRACE_SCHEMA = "openmind.maf_phase_6e_b_expansion_trace_snapshot.v1"
RESULT_SCHEMA = "openmind.maf_phase_6e_b_bounded_expansion_recovery.v1"
...
class Phase6EBIntegrityError(RuntimeError):
    pass


def need(condition, message):
    if not condition:
        raise Phase6EBIntegrityError(message)
...
def git(*args):
    ...
    if result.returncode != 0:
        raise Phase6EBIntegrityError("git failed: " + " ".join(args))
...
def verify_pre_execution_state():
    need(not os.path.lexists(OUTPUT_PATH), "result path already exists")
...
def main():
    ...
    print("=" * 72)
    print(" OPENMIND / PHASE 6E-B BOUNDED EXPANSION RECOVERY V1")
    print("=" * 72)
...
if __name__ == "__main__":
    ...
    except Phase6EBIntegrityError as exc:
        print("PHASE 6E-B INFRASTRUCTURE/INTEGRITY FAILURE:", str(exc), file=sys.stderr)
        raise SystemExit(2)
