#!/usr/bin/env python3
"""Exact-once Phase 6C MAF Object Runtime and Residency V1 validation."""
...
VALID_PROTOCOL_PATH = Path(
    "experiments/model_fractal/"
    "MAF_OBJECT_RUNTIME_RESIDENCY_VALIDATION_V1_PROTOCOL.md"
)
...
RESULT_PATH = Path(
    "experiments/model_fractal/"
    "maf_object_runtime_residency_validation_v1.json"
)
...
VALIDATION_RUNTIME = Path(
    "results/runtime/"
    "maf_object_runtime_residency_validation_v1"
)
...
def main() -> int:
    if RESULT_PATH.exists():
        raise ValidationHarnessError(
            "validation result already exists; V1 rerun forbidden"
        )
    ...
    print(
        "OPENMIND / MAF OBJECT RUNTIME RESIDENCY VALIDATION V1"
    )
    print(
        "validation_valid:",
