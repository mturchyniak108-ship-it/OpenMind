...
RESULT_SCHEMA = (
    ...
    "telemetry_snapshot_persistence_validation.v1_3"
)
...
VALIDATION_PROTOCOL_PATH = Path(
    "experiments/model_fractal/"
    "MAF_SEGMENT_LOCALITY_TELEMETRY_SNAPSHOT_"
    "PERSISTENCE_VALIDATION_V1_3_PROTOCOL.md"
)
...
RESULT_PATH = Path(
    "experiments/model_fractal/"
    "maf_segment_locality_telemetry_snapshot_"
    "persistence_validation_v1_3.json"
)

RESULT_TEMP_PATH = Path(
    "experiments/model_fractal/"
    "maf_segment_locality_telemetry_snapshot_"
    "persistence_validation_v1_3.json.tmp"
)
...
V1_2_PROTOCOL_COMMIT = "c545c871c94669423cd17a00c3506cc9c1fd4f04"

V1_3_RUNNER_RELATIVE_PATH = (
    "experiments/model_fractal/"
    "maf_segment_locality_telemetry_snapshot_"
    "persistence_validation_v1_3.py"
)

V1_1_VALIDATION_PROTOCOL_PATH = Path(
    "experiments/model_fractal/"
    "MAF_SEGMENT_LOCALITY_TELEMETRY_SNAPSHOT_PERSISTENCE_VALIDATION_V1_1_PROTOCOL.md"
)

V1_1_VALIDATION_PROTOCOL_SHA256 = (
    "13cf1798492853be098b6e8ea31d9b0f"
    "baf0a047f425bd2fdda91bae34ad2841"
)

V1_1_VALIDATION_RUNNER_PATH = Path(
    "experiments/model_fractal/"
    "maf_segment_locality_telemetry_snapshot_persistence_validation_v1_1.py"
)

V1_1_VALIDATION_RUNNER_SHA256 = (
    "0733ccba7ca1b80af56ded82d6df5703"
    "788db60f235a832173b3339a56bf8c68"
)

V1_1_VALIDATION_RESULT_PATH = Path(
    "experiments/model_fractal/"
    "maf_segment_locality_telemetry_snapshot_persistence_validation_v1_1.json"
)

V1_1_VALIDATION_RESULT_SHA256 = (
    "5a31aa4f3d476a0c56d433d2268c9fa"
    "9f0641ed1210be945c70b9cf7c6193994"
)

V1_1_VALIDATION_VERDICT_PATH = Path(
    "experiments/model_fractal/"
    "MAF_SEGMENT_LOCALITY_TELEMETRY_SNAPSHOT_PERSISTENCE_VALIDATION_V1_1_VERDICT.md"
)

V1_1_VALIDATION_VERDICT_SHA256 = (
    "5105a8f461d0857639a793b41071271a"
    "3d14b3caebeba95aea4b4784cf6da61f"
)

V1_1_VALIDATION_RUNNER_COMMIT = (
    "e06cdcead9644005b9bb916c489bad49467f1248"
)

V1_1_VALIDATION_RESULT_COMMIT = (
    "55b82920ba3a9359f373fb17ce848e222ded3701"
)

V1_1_VALIDATION_VERDICT_COMMIT = (
    "8fa8f85a41b75f157f5e61dcf32772079d222e21"
)

SCIENTIFIC_IMPORT_MODULES = (
    "experiments.model_fractal.maf_segment_locality_data_model_v1",
    "experiments.model_fractal."
    "maf_segment_locality_telemetry_snapshot_persistence_v1_1",
)

def verify_v1_1_closed_lineage(
    protocol_sha,
    runner_sha,
    result_sha,
    verdict_sha,
    ...
    exact_arguments = (
        (
            protocol_sha,
            V1_1_VALIDATION_PROTOCOL_SHA256,
            "Validation V1.1 protocol SHA",
        ),
        (
            runner_sha,
            V1_1_VALIDATION_RUNNER_SHA256,
            "Validation V1.1 runner SHA",
        ),
        (
            result_sha,
            V1_1_VALIDATION_RESULT_SHA256,
            "Validation V1.1 result SHA",
        ),
        (
            verdict_sha,
            V1_1_VALIDATION_VERDICT_SHA256,
            "Validation V1.1 verdict SHA",
        ),
        (
            runner_commit,
            "e06cdcead9644005b9bb916c489bad49467f1248",
            "Validation V1.1 runner commit",
        ),
        (
            result_commit,
            "55b82920ba3a9359f373fb17ce848e222ded3701",
            "Validation V1.1 result commit",
        ),
        (
            verdict_commit,
            "8fa8f85a41b75f157f5e61dcf32772079d222e21",
            "Validation V1.1 verdict commit",
        ),
    )

    for actual, expected, label in exact_arguments:
        if actual != expected:
            raise HarnessInvalid(
                label
                + " identity mismatch"
    ...
    frozen = (
        (
            V1_1_VALIDATION_PROTOCOL_PATH,
            protocol_sha,
            "Validation V1.1 protocol",
        ),
        (
            V1_1_VALIDATION_RUNNER_PATH,
            runner_sha,
            "Validation V1.1 runner",
        ),
        (
            V1_1_VALIDATION_RESULT_PATH,
            result_sha,
            "Validation V1.1 raw result",
        ),
        (
            V1_1_VALIDATION_VERDICT_PATH,
            verdict_sha,
            "Validation V1.1 formal verdict",
        ),
    )

    for relative_path, expected_sha, label in frozen:
        artifact = (
            REPO_ROOT
            / relative_path
        )
    ...
    for evidence in required_verdict_evidence:
        if evidence not in verdict_text:
            raise HarnessInvalid(
                "Validation V1.1 closed-lineage evidence missing: "
                + evidence
            )


def repository_scientific_module_inventory():
    prefix = "experiments"
...
def verify_scientific_import_inventory(
    before,
):
    if not isinstance(
        before,
        ...
        raise HarnessInvalid(
            "pre-import scientific-module inventory is invalid"
        )

    after = (
        repository_scientific_module_inventory()
    )
    ...
    for module_name in SCIENTIFIC_IMPORT_MODULES:
    ...
    expected_added.difference_update(
        before
    )
    ...
    if actual_added != frozenset(
        expected_added
    ):
        raise HarnessInvalid(
            "unexpected repository scientific module imports: "
            + repr(
                sorted(
                    actual_added
                )
    ...
    for module_name in SCIENTIFIC_IMPORT_MODULES:
        if module_name not in sys.modules:
            raise HarnessInvalid(
                "expected scientific module missing after import: "
                + module_name
            )

PHASE6C_ENGINE_PATH = Path(
...
V1_2_VALIDATION_PROTOCOL_PATH = Path(
    "experiments/model_fractal/MAF_SEGMENT_LOCALITY_TELEMETRY_SNAPSHOT_PERSISTENCE_VALIDATION_V1_2_PROTOCOL.md"
)

V1_2_VALIDATION_PROTOCOL_SHA256 = (
    "67ecf94c2c85451cf31644d48c9c4738b6d87ccefb4f0971340b4d90d9ebc818"
)

V1_2_VALIDATION_PROTOCOL_COMMIT = (
    "c545c871c94669423cd17a00c3506cc9c1fd4f04"
)

V1_2_VALIDATION_RUNNER_PATH = Path(
    "experiments/model_fractal/maf_segment_locality_telemetry_snapshot_persistence_validation_v1_2.py"
)

V1_2_VALIDATION_RUNNER_SHA256 = (
    "af0d335601f79f1366825844da081e03e8dbb912d7bbffe881669808a8df0816"
)

V1_2_VALIDATION_RUNNER_COMMIT = (
    "6c53c4c3e93b5409a17257d758fb222da04b6499"
)

V1_2_VALIDATION_VERDICT_PATH = Path(
    "experiments/model_fractal/MAF_SEGMENT_LOCALITY_TELEMETRY_SNAPSHOT_PERSISTENCE_VALIDATION_V1_2_VERDICT.md"
)

V1_2_VALIDATION_VERDICT_SHA256 = (
    "e8b1dc54dd8ddc99d94eeac03aded99f33a13db626b452e901b56d8753a91f91"
)

V1_2_VALIDATION_VERDICT_COMMIT = (
    "bc2a04b4bf1684e2b43b6eb284f882d66c606dcc"
)


def verify_v1_2_closed_lineage():
    exact_constants = (
        (
            V1_2_VALIDATION_PROTOCOL_COMMIT,
            "c545c871c94669423cd17a00c3506cc9c1fd4f04",
            "V1.2 validation protocol commit",
        ),
        (
            V1_2_VALIDATION_RUNNER_COMMIT,
            "6c53c4c3e93b5409a17257d758fb222da04b6499",
            "V1.2 validation runner commit",
        ),
        (
            V1_2_VALIDATION_VERDICT_COMMIT,
            "bc2a04b4bf1684e2b43b6eb284f882d66c606dcc",
            "V1.2 validation verdict commit",
        ),
    )

    for actual, expected, label in exact_constants:
        if actual != expected:
            raise HarnessInvalid(
                label
                + " identity mismatch"
    ...
    frozen = (
        (
            V1_2_VALIDATION_PROTOCOL_PATH,
            V1_2_VALIDATION_PROTOCOL_SHA256,
            "V1.2 validation protocol",
        ),
        (
            V1_2_VALIDATION_RUNNER_PATH,
            V1_2_VALIDATION_RUNNER_SHA256,
            "V1.2 validation runner",
        ),
        (
            V1_2_VALIDATION_VERDICT_PATH,
            V1_2_VALIDATION_VERDICT_SHA256,
            "V1.2 validation verdict",
        ),
    )
    ...
    for evidence in required_evidence:
        if evidence not in verdict_text:
            raise HarnessInvalid(
                "V1.2 closure evidence missing: "
                + evidence
            )


def verify_v1_3_predecessor_lineage():
    failures = []

    try:
        verify_v1_1_closed_lineage(
                V1_1_VALIDATION_PROTOCOL_SHA256,
                V1_1_VALIDATION_RUNNER_SHA256,
                V1_1_VALIDATION_RESULT_SHA256,
                V1_1_VALIDATION_VERDICT_SHA256,
    ...
    if failures:
        ...
        raise HarnessInvalid(
            "closed predecessor lineage invalid: "
            + " | ".join(details)
        )
...
def binding_gate():
    frozen = (
        ...
        (
            ...
            PERSISTENCE_PROTOCOL_SHA256,
            "Persistence V1.1 protocol",
        ),
        (
            PERSISTENCE_PATH,
            PERSISTENCE_SHA256,
            "Persistence V1.1 implementation",
        ),
        (
            PERSISTENCE_V1_PROTOCOL_PATH,
            PERSISTENCE_V1_PROTOCOL_SHA256,
            "Persistence V1 protocol",
        ),
        (
            PERSISTENCE_V1_PATH,
            PERSISTENCE_V1_SHA256,
            "Persistence V1 implementation",
        ),
        (
            PERSISTENCE_V1_VALIDATION_PROTOCOL_PATH,
            PERSISTENCE_V1_VALIDATION_PROTOCOL_SHA256,
            "Validation V1 protocol",
        ),
        (
            PERSISTENCE_V1_VALIDATION_RUNNER_PATH,
            PERSISTENCE_V1_VALIDATION_RUNNER_SHA256,
            "Validation V1 runner",
        ),
        (
            DATA_MODEL_PATH,
            DATA_MODEL_SHA256,
        ...
        (
            ...
            DATA_MODEL_RESULT_SHA256,
            "locality data-model result",
        ),
        (
            DATA_MODEL_VERDICT_PATH,
            DATA_MODEL_VERDICT_SHA256,
            "locality data-model verdict",
        ),
        (
            PHASE6C_ENGINE_PATH,
            PHASE6C_ENGINE_SHA256,
            "closed Phase 6C engine",
        ),
        (
            V1_1_VALIDATION_PROTOCOL_PATH,
            V1_1_VALIDATION_PROTOCOL_SHA256,
    ...
    if (
        ...
        raise HarnessInvalid(
            "Validation V1 result namespace is not pristine"
        )
    ...
    if (
        ...
        raise HarnessInvalid(
            "Validation V1.1 result unexpectedly became a symlink"
        )
    ...
    if (
        ...
        raise HarnessInvalid(
            "Validation V1.2 result namespace is not pristine"
        )

    for module_name in SCIENTIFIC_IMPORT_MODULES:
        if module_name in sys.modules:
            raise HarnessInvalid(
                "scientific module imported before V1.2 reservation: "
                + module_name
            )

    verify_v1_3_predecessor_lineage()
...
def prepare_repo_import_root():
    ...
    if not experiments_dir.is_dir():
        raise HarnessInvalid(
            "repository experiments directory missing"
        )

    if not model_fractal_dir.is_dir():
        raise HarnessInvalid(
            "repository model_fractal directory missing"
        )

    for module_name in SCIENTIFIC_IMPORT_MODULES:
        if module_name in sys.modules:
            raise HarnessInvalid(
                "scientific module present before import-root correction: "
                + module_name
            )
    ...
    if (
        ...
        raise HarnessInvalid(
            "repository import root is not sys.path[0]"
        )
...
def main():
    ...
    # V1.2 preregistered pre-reservation import-root gate.
    prepare_repo_import_root()
    reserve_result_slot()
    ...
    try:
        ...
        verify_scientific_import_inventory(
            scientific_modules_before
        )
        ...
        try:
            ...
            if result["auditor_error"] is None:
                result["auditor_error"] = {
                    "type": type(exc).__name__,
                    "message": str(exc),
                    "origin": "validation_harness",
                    "traceback": traceback.format_exc(),
                }
            result["validation_valid"] = False
            result["all_pass"] = False
