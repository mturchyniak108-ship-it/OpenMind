...
SCHEMA = "openmind.maf_resident_pk_directory_diagnostics.v1_4"
VERSION = "maf_resident_pk_directory_diagnostics_v1_4"
...
V1_4_CORRECTION_PROTOCOL = Path("experiments/model_fractal/MAF_RESIDENT_PK_DIRECTORY_DIAGNOSTICS_V1_4_CORRECTION_PROTOCOL.md")
V1_4_CORRECTION_PROTOCOL_SHA256 = "dbb86b4ef1c9cb01efeda00893b8710562895bd347145540335bb20303c1d337"
...
RESULT = Path("experiments/model_fractal/maf_resident_pk_directory_diagnostics_v1_4.json")
RUNTIME = Path("results/runtime/maf_resident_pk_directory_diagnostics_v1_4")
...
EXPECTED_STALE_EXCEPTION_TYPE = "MAFResidentPKDirectoryStaleSnapshotError"
...
def run_diagnostics():
    ...
    checks["stale_rejection_exception_type_exact"] = (
        stale_exception_types == {EXPECTED_STALE_EXCEPTION_TYPE}
    )
    ...
    return {
        ...
        "diagnostic_v1_4_correction_protocol_sha256": V1_4_CORRECTION_PROTOCOL_SHA256,
        ...
        "stale_state_stress": {
            ...
            "expected_exception_type": EXPECTED_STALE_EXCEPTION_TYPE,
...
def main():
    ...
    print("=" * 72)
    print(" OPENMIND / RESIDENT PK DIRECTORY DIAGNOSTICS V1.4")
    print("=" * 72)
