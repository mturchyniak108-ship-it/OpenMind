# OpenMind CPU Thermal Characterization V1.1 Protocol
...
The frozen V1.1 runner may execute exactly once.
...
Result path:
    ...
    experiments/model_fractal/cpu_thermal_characterization_v1_1.json

Schema:

    openmind.cpu_thermal_characterization.v1_1
...
After V1.1 interpretation, the confirmed per-CPU operating windows
