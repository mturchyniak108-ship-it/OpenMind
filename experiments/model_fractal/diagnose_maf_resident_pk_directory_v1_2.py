...
SCHEMA = "openmind.maf_resident_pk_directory_diagnostics.v1_2"
VERSION = "maf_resident_pk_directory_diagnostics_v1_2"
...
RESULT = Path("experiments/model_fractal/maf_resident_pk_directory_diagnostics_v1_2.json")
RUNTIME = Path("results/runtime/maf_resident_pk_directory_diagnostics_v1_2")
...
def prepare_lookup(snapshot, key):
    values = {
...
def main():
    ...
    print("=" * 72)
    print(" OPENMIND / RESIDENT PK DIRECTORY DIAGNOSTICS V1.2")
    print("=" * 72)
