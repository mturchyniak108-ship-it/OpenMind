...
OUT = Path(
    "experiments/model_fractal/maf_workload_benchmark_v1.json"
)
...
def main():
    ...
    output = {
        "format":
            "openmind.maf_workload_benchmark.v1",
    ...
    print("=" * 72)
    print(" OPENMIND / MAF WORKLOAD BENCHMARK V1")
    print("=" * 72)
